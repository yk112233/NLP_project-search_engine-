...
class Indexer:
    ...
    def index_writer(self, file_path):
        ...
        for i in range(sheet1.nrows):
            ...
            read = sheet1.cell(i, 8).value
            doc = Document(key, title, neirong, link, emotion, like, comment, collection, read)
...
def highlight(docs, terms):
    ...
    for doc in docs:
        ...
        result.append((doc.get('link'), content, doc.get('emotion'), doc.get('like'), doc.get('comment'), doc.get('collection'), doc.get('read')))
    return result
