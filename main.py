...
class Document:
    def __init__(self, key, title, neirong, link, emotion):
        self.dict = {'key': key, 'title': title, 'neirong':neirong, 'link': link, 'emotion': emotion}
...
class Indexer:
    ...
    def index_writer(self, file_path):
        ...
        for i in range(sheet1.nrows):
            ...
            doc = Document(key, title, neirong, link, emotion)
...
def highlight(docs, terms):
    ...
    for doc in docs:
        ...
        result.append((doc.get('link'), content, doc.get('emotion')))
    return result
